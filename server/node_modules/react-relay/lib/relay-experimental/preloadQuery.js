...
var ReplaySubject = require('relay-runtime/lib/util/RelayReplaySubject');

var getRequestIdentifier = require('relay-runtime/lib/util/getRequestIdentifier');
...
function preloadQueryDeduped(environment, pendingQueries, preloadableRequest, variables, options) {
  ...
  var fetchPolicy = (_ref = options === null || options === void 0 ? void 0 : options.fetchPolicy) !== null && _ref !== void 0 ? _ref : STORE_OR_NETWORK_DEFAULT;
  ...
  var shouldFulfillFromCache = fetchPolicy === STORE_OR_NETWORK_DEFAULT && query != null && ((prevQueryEntry === null || prevQueryEntry === void 0 ? void 0 : prevQueryEntry.kind) === 'cache' || environment.check(createOperationDescriptor(query, variables).root));
  var nextQueryEntry;
  ...
  if (shouldFulfillFromCache) {
    ...
    var source = network.execute(params, variables, {}, null, logRequestInfo);
